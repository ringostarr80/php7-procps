...
COMPILER_FLAGS      =   -Wall -I/usr/local/include -c -O2 -std=c++11 -fpic -o
LINKER_FLAGS        =   -shared -Wl,-rpath,'/usr/local/lib'
LINKER_DEPENDENCIES =   -lphpcpp -lprocps
...
SOURCES             =   $(wildcard *.cpp RingoLeese/*.cpp)
